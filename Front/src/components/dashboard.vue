        ...
        <div class="page-sidebar-inner">
          <div class="page-sidebar-menu">
            <ul class="accordion-menu">
              ...
              <li>
                <router-link :to="{name: 'market', params: {user: this.$store.state.user}}">
                  ...
                  <div class="panel-body">
                    <div class="browser-stats">
                      <ul class="list-unstyled">
                        ...
                        <li>
                          <i class="fa fa-tablet"></i>Mobile &amp; tablet
                          <div class="text-success pull-right">
                            4%
                            <i class="fa fa-level-up"></i>
                          </div>
                        ...
                        <li>
                          <i class="fa fa-hashtag"></i>Others
                          <div class="text-success pull-right">
                            3%
                            <i class="fa fa-level-up"></i>
                          </div>
                    ...
                    <div class="project-stats">
                      <ul class="list-unstyled">
                        <li>
                          ...
                          <span class="label label-default pull-right">85%</span>
                        </li>
                        <li>
                          Meteor - Landing Page
                          <span class="label label-success pull-right">Finished</span>
                        </li>
                        <li>
                        ...
                        <li>
                          ecaps - Admin Template
                          <span class="label label-danger pull-right">Rejected</span>
                        </li>
                        <li>
                          Backend UI
                          <span class="label label-default pull-right">27%</span>
                        </li>
                        <li>
                          Personal Blog
